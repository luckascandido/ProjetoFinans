   ...
   <div class="container">
          ...
          <div class="collapse navbar-collapse" id="nav-principal">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a href="" class=" fw-bold nav-link">Recursos</a>
              </li>
              <li class="nav-item">
                <a href="" class=" fw-bold nav-link">Benefícios</a>
              </li>
              <li class="nav-item">
                <a href="" class=" fw-bold nav-link">Preços</a>
              </li>
              <li class="nav-item">
                <a href="" class="fw-bold btn btn-outline-light ms-4">Entrar</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section id="home"><!--inicio home-->
      <div class="container">
        <div class="row">
            ...
            <div class="align-self-center">
              ...
              <form class="mt-4 mb-4">
                <div class="input-group">
                  <input type="text" placeholder="Insira o seu Email." class="form-control">
          ...
          <div class="col-md-3 content-justify-end  d-none d-md-block">
    ...
    <br>
    <section class="caixa m-2"><!--/Início seção recursos -->
      <div class="container">
        <div class="row">
          <div class="col-md-4">
    ...
    <br>
    <footer class="bg-warning"><!--rodape-->
    <div class="container ">
        <div class="row">
          <div class="col-md-8  ">
            <p class="d-flex flex-row  ">
              <a  class=" fw-bold nav-link mt-3 me-2 opacity-75 justify-content-center" href="">Home </a>
              <a   class=" fw-bold nav-link mt-3 me-2 opacity-75 justify-content-center "href=""> Recursos </a>
              <a  class=" fw-bold nav-link mt-3 me-2 opacity-75 justify-content-center"href=""> Benefícios </a>
              <a   class="fw-bold nav-link mt-3 me-2 opacity-75 justify-content-center"href=""> Preços</a>
            </p>
          </div>
          <div class="col-md-4 d-flex justify-content-end">
            <a href="" class="btn btn-outline-dark align-self-center">
              <i class="fab fa-facebook"></i>
            </a>
            <a href="" class="btn btn-outline-dark ms-2 align-self-center">
